...
--Q2.5
--insert professor first because the course table utilizes data from the professor table, such as professor email and professor name
...
--Q2.6
--update first because it will still show p1
update course 
